...
def normalized_data(df):
    ...
    df_cop['PAYMENT_DAY'] = df_cop['PAYMENT_DAY'].astype('category')
    ...
    df_cop["MONTHS_IN_RESIDENCE"] = df_cop["MONTHS_IN_RESIDENCE"].astype('category')
    ...
    df_cop['HAS_CARDS'] = np.where(df_cop[list_cards].any(axis=1), "Y", "N")
    ...
    df_cop["HAS_BANKING_ACCOUNTS"] = np.where(df_cop["QUANT_BANKING_ACCOUNTS"] == 0, 'N', 'Y')
